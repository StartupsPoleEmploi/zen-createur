...
const selectPreviewedEmployerDocId = (state) => state.declarationsReducer.previewedEmployerFileId;
const selectPreviewedInfoDocId = (state) => state.declarationsReducer.previewedInfoFileId;

export const selectPreviewedEmployerDoc = createSelector(
  [selectDeclarations, selectPreviewedEmployerDocId],
  (declarations, documentId) => utils.findEmployerDoc({ declarations, documentId }),
);

export const selectPreviewedInfoDoc = createSelector(
  [selectDeclarations, selectPreviewedInfoDocId],
  (declarations, documentId) => utils.findDeclarationInfo({ declarations, documentId }),
);
