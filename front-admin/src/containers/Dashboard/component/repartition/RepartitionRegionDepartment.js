...
function RepartitionRegionDepartment({
  usersGlobalRepartition, region, department, declarationMonth,
  selectRegion, selectDepartment, selectAgency,
}: Props) {
              ...
              return (
                <li key={regionName}>
                  ...
                  >
                    ...
                    <br /> sur {formatNb(totalUsersRegion)} assistantes maternelles (
